        ...
        <div>
            ...
            <div class="TextoPrimero" align="center">
                <div>
                    ...
                    <asp:TextBox CssClass="CajasTextos" ID="txt_IdMonitor" runat="server" Height="31px" Width="375px" ToolTip="Solo se permiten numeros" 
                        onkeypress="javascript:return solonumeros(event)">
                    </asp:TextBox>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                            ControlToValidate="txt_IdMonitor" 
                            ErrorMessage="Solo Numeros"
                            ForeColor="Red"
                            ValidationExpression="^[0-9]*">
